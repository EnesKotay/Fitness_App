...
class _FoodSearchPageState extends State<FoodSearchPage> {
  ...
  Future<void> _loadRecommendations() async {
    try {
      ...
      final recs = await provider.searchFoods('', category: null);
      if (mounted) {
      ...
      child: Column(
        ...
        children: [
          ...
          if (_recommendedFoods.isNotEmpty) ...[
            ...
            ..._recommendedFoods.map((food) => _FoodListTile(
                  food: food,
                  selectedMealType: _effectiveMealType,
                  onTap: () => _openDetail(food),
                  onAddTap: () => _openPortion(food),
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                          hintText: _isAISearch ? 'Örn: 2 yumurta ve 1 dilim ekmek' : 'Yulaf, Yumurta, Elma...',
                    ...
                    GestureDetector(
                      ...
                      child: Tooltip(
                        message: 'Yapay Zeka ile Ara',
                        child: Icon(
                          _isAISearch ? Icons.auto_awesome : Icons.auto_awesome_outlined,
            ...
            child: Row(
              children: [
                Container(
                  ...
                  child: const Icon(Icons.restaurant_rounded, color: AppColors.secondary, size: 28),
                ),
                      ...
                      Row(
                        children: [
                          ...
                          if (food.servings.isNotEmpty) ...[
                            ...
                            Icon(Icons.restaurant_menu, size: 12, color: AppColors.secondary.withValues(alpha: 0.9)),
                          ],
                        ],
                      ),
                      const SizedBox(height: 8),
