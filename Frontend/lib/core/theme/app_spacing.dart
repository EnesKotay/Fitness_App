...
class AppSpacing {
  ...
  static const EdgeInsets edgeInsetsHS = EdgeInsets.symmetric(horizontal: s);
  static const EdgeInsets edgeInsetsHM = EdgeInsets.symmetric(horizontal: m);
  static const EdgeInsets edgeInsetsHL = EdgeInsets.symmetric(horizontal: l);
