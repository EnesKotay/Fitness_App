...
void main() {
  ...
  final scoreUstaDonerci = scoreFood(
    "Usta Dönerci Et Döner Dürüm",
    "Usta Dönerci",
    ["et döner dürüm", "döner dürüm", "döner"],
    ["et", "döner", "dürüm", "fastfood"],
    "döner",
  );
  final scoreEtDoner = scoreFood(
    "Et Döner",
    null,
    ["döner", "yaprak döner"],
    ["et", "türk mutfağı"],
  ...
  final scoreDonerPorsiyon = scoreFood(
    "Döner (Porsiyon)",
    null,
    ["döner"],
    ["et", "türk mutfağı"],
