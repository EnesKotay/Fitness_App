...
import 'file:///Users/eneskotay/Development/Fitness_App-main/frontend/test/features/tasks/daily_task_storage_test.dart' as test;
...
void main() {
  ...
  StreamChannel<dynamic> testChannel = serializeSuite(() {
    catchIsolateErrors();
    goldenFileComparator = LocalFileComparator(Uri.parse('file:///Users/eneskotay/Development/Fitness_App-main/frontend/test/features/tasks/daily_task_storage_test.dart'));
